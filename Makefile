...
ifeq ($(findstring gfortran,$(FORT_NOPATH)),gfortran)
  ...
  FLAGSF90=-Wall -fbounds-check -g -fbacktrace -fcheck=all
  FLAGSF77=$(FLAGSF90)
...
doku:
	...
	@echo "  Generated from release 2016 revision `svnversion -n .` with ROBODoc `robodoc --version` on `date` "  >> ../Documentation/index.html
...
objects/version.f90 : $(allSrcFiles)
	...
	@echo ' write(*,2) "Release     : 2016" '                        >> ./code/inputOutput/version.f90
