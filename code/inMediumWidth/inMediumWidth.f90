...
contains
  ...
  !***************************************************************************
  function evaluateCollisionBroadening_baryons(particleID,momentumLRF,mass,rhoN,rhoP,monte_in,gcoll_elastic_out) RESULT(gcoll)
    use particleDefinition
    use random
    ...
    nucleonChargeLoop: do charge=0,1
       ...
       monteCarloLoop :  do i=1,num_MonteCarlo_Points_local
          ...
          iF(debugFlag) then
             ...
             write(*,'(4G18.3)') absmom(nuc), absMom(part),momentumLRF
