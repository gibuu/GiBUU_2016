...
module nucleusDefinition
  ...
  type, public :: tNucleus
     ...
     integer   :: mass                     ! in units of nucleon masses
     integer   :: charge
     ...
     real       :: chemPot     ! 'chemical' Potential for LDA (relative
                                  ! units of E0)
     logical    :: ReAdjustForConstBinding
     real       :: ConstBinding
     real       :: facN, facP ! scaling factors in Readjust
