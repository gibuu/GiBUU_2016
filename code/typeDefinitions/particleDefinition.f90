...
contains
  ...
  ! cf. interface "sqrtS" :
  !*************************************************************************
  real function sqrtSOne(x) !Sqrt(s) of one particle
    type(particle), intent(in) :: x
  ...
  !-------------------------------------------------------------------------
  real function sqrtSTwo(x,y) !Sqrt(s) of two particles
...
!   end function sqrtSTwoT
  ...
  !-------------------------------------------------------------------------
  real function sqrtSThree(x,y,z) !Sqrt(s) of three particles
...
!   end function sqrtSThreeT
  ...
  !-------------------------------------------------------------------------
  real function sqrtSVec(Part) ! Sqrt(s) of Vector
