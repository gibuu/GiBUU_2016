...
! Hadrons listed here can be included in detailed analyses, see  namelist &detailed_diff
  ...
  ! PURPOSE
  ! The ID's of the particles we consider "stable". For these detailed analyses can be performed
  ...
  ! The first index in numberParticles runs over all stable hadrons used in the analysis + 1,
  ! (numStableParts + 1), the second one over the possible charge states (-2 -> +2)
  !
  ! SOURCE
  !
  Type tAnaEvent
