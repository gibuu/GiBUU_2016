...
contains
  ...
  subroutine readinput
    ...
    ! * twoPi_switch
    !***************************************************************************
    NAMELIST /pionAnalysis/ debug, CMFrame, dsigma_dOmegadE_switch, twoPi_switch
  ...
  subroutine dSigmadOmegadE(pertParticles,finalFlag)
    ...
    real, parameter :: maxEkin=0.240  ! Maximal kinetic energy for binning
...
& getEKin(), '. Number of runs:', numberruns
  ...
  ! Parameter integration
  !
  ! Gives dSigma/dOmega/dE(pion) for Pions in file. Only those pions are considered which are
  ! produced in NN collisions.
  ! USES
