  ...
  contains
    ...
    subroutine cdmj
      ...
      IF (IDEUTERON.EQ.2) THEN !     full model
         ...
         D( 7)= .44956539D+1
         D( 8)=-.71152863D-1
      ELSEIF(IDEUTERON.EQ.10)THEN   ! OBEPQ [MaH87]
         JMAX=11
         ALPHA=  0.231609d0
         C( 1)=  0.88628672d0
         C( 2)= -0.27591814d0
      ...
      ELSEIF(IDEUTERON.EQ.11)THEN   ! OBEPQA [Mac89]
         ...
         D( 7)= -0.20707396e+02
         D( 8)=  0.12048237e+02
      ELSEIF(IDEUTERON.EQ.12)THEN   ! OBEPQB [Mac89]
         JMAX=11
         ALPHA=  0.231607d0
         C( 1)=  0.88611410E+00
         C( 2)= -0.24885006E+00
         ...
         D( 7)= -0.12845278E+02
         D( 8)=  0.74194734E+01
      ELSEIF(IDEUTERON.EQ.13)THEN   ! OBEPQC [Mac89]
         JMAX=11
         ALPHA=  0.231607d0
         C( 1)=  0.88507948E+00
         C( 2)= -0.24105451E+00
         ...
         D( 7)= -0.81817727E+01
         D( 8)=  0.45534069E+01
      ELSEIF(IDEUTERON.EQ.20)THEN   ! OBEPR [MaH87]
         JMAX=11
