...
module formfactors_A_piMinus_proton
  ...
  public :: getA_piMinus_proton, cleanUp
...
contains
  ...
  !*************************************************************************
  function getA_piMinus_proton (thetaIn,sIn,QSquaredIn) result(getA)
    ...
    if (initFlag) then
       call Write_InitStatus('MAID Amplitudes for gamma n -> p pi-',0)
       call init_datFile_pimp
       initFlag=.false.
       ...
       call Write_InitStatus('MAID Amplitudes for gamma n -> p pi-',1)
    end if
  ...
  contains
    ...
    !*************************************************************************
    !****if* getA_piMinus_proton/get_neighbors
    ! NAME
    ...
    !*************************************************************************
    !****if* getA_piMinus_proton/init_datFile
    ! NAME
    ...
    subroutine init_datFile_pimp
      ...
      f = bzOpenR(trim(get_Filename('pimp')))
    ...
    end subroutine init_datFile_pimp
  end function getA_piMinus_proton
...
end module formfactors_A_piMinus_proton
