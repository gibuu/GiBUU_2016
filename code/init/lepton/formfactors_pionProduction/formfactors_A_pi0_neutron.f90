!***************************************************************************
!****m* /formfactors_A_piZero_neutron
! NAME
! module formfactors_A_piZero_neutron
!
! PURPOSE
...
!
! For the isospin channel gamma n -> n pi^0.
!
! INPUTS
! None
!***************************************************************************
...
contains
  ...
  !*************************************************************************
  !****f* formfactors_A_piZero_neutron/getA_piZero_neutron
  ! NAME
  ! function getA_piZero_neutron(thetaIn,sIn,QSquaredIn)
  !
  ! PURPOSE
  ...
  !*************************************************************************
  function getA_piZero_neutron (thetaIn,sIn,QSquaredIn) result(getA)
    ...
    if (initFlag) then
       call Write_InitStatus('MAID Amplitudes for gamma n -> n pi0',0)
       call init_datFile_pi0n
       initFlag=.false.
       ...
       call Write_InitStatus('MAID Amplitudes for gamma n -> n pi0',1)
    end if
  ...
  contains
    ...
    !*************************************************************************
    !****if* getA_piZero_neutron/get_neighbors
    ! NAME
    ...
    !*************************************************************************
    !****if* getA_piZero_neutron/init_datFile
    ! NAME
    ...
    subroutine init_datFile_pi0n
      ...
      f = bzOpenR(trim(get_Filename('pi0n')))
      ...
      if(debug) then
         ! Control output
         open(101,file='FF_A_pi0neutron.dat')
    ...
    end subroutine init_datFile_pi0n
  end function getA_piZero_neutron
...
end module formfactors_A_piZero_neutron
