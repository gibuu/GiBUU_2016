...
module histMC
  ...
  public :: CreateHistMC, RemoveHistMC, clearHistMC, CopyDesc, AddHistMC, rebinHistMC
  public :: WriteHeaderMC, WriteHistMC, WriteHistMC_Integrated, WriteHistMC_Gauss
  public :: ReadHistMC, FetchHistMC, sumHistMC
...
!   end subroutine WriteHistMC_Spline
  ...
  function ReadHistMC (H, file, w) result (success)
    ...
    integer :: i,ios, head, numbins, nCh, linelen
    real :: x,s
    character(20) :: f
