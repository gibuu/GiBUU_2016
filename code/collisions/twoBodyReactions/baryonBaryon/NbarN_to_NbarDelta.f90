...
! PURPOSE
! Includes the Nbar N <-> Nbar Delta cross sections according to the one-pion exchange model.
! NOTES:
...
module NbarN_to_NbarDelta
  ...
  Public :: massNbarN_NbarDelta,NbarN_to_NbarDelta_Integrated, NbarDelta_to_NbarN, NbarN_to_NbarDelta_dm, &
            calculate, calculate1, mNbarN_to_NbarD2
...
!****      Relativistic matrix element^2 :
    ...
    real function mNbarN_to_NbarD2 (t, m_1, m_2, m_3, m_4)
      ...
      if (debugflag) print *,' mNbarN_to_NbarD2:', mNbarN_to_NbarD2
